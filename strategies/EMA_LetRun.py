"""EMA momentum entry, slow 100-day SMA exit — let winners run."""
...
class EMA_LetRun(Strategy):
    fast_period = 10
    slow_period = 30
    mom_period = 10
    exit_period = 100  # slow SMA for exit
    stop_loss_pct = 12
    ...
    def next(self):
        if not self.position:
            ...
            # Only exit when price drops below 100-day SMA
